...
export const CONNECT_PROFILE_FILES = {
  ...
  temporaryBases: ["connect-pending.json", "connect-complete.json", "credential.json", "profile.json"],
...
export function reservedConnectProfileName(name: string): boolean {
  ...
  if ([CONNECT_PROFILE_FILES.pending, CONNECT_PROFILE_FILES.complete, CONNECT_PROFILE_FILES.credential,
...
export function reservedConnectProfileNames(): string {
  return [CONNECT_PROFILE_FILES.pending, CONNECT_PROFILE_FILES.complete, CONNECT_PROFILE_FILES.credential,
