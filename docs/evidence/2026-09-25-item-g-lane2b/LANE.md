...
- Fold 14's full service-free, CLI, server, edge, site and release gates await the lead. The lead ran Fold 13's gates at 80a6915f; its CLI gate was red on XX2's mapping defect. The new supervisor-versus-real-`ps` control is not measured outside this sandbox yet.
